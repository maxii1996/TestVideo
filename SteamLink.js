...
globalThis.CyclonePatcher = class {
  static initialize(t) {
...
class e extends CyclonePatcher {
  static initialize(t) {
  ...
  static loadParamMap(t, e) {
      ...
      for (const s in t)
          if (t.hasOwnProperty(s)) try {
              ...
              console.error(`CycloneEngine crashed while trying to parse a parameter value (${s}). Please report the following error to Hudell:`), console.log(t);
          }
      return r
  }
  ...
  static runEvent(t, {
      ...
      for (const t of n) {
          ...
          if ("function" != typeof t) {
              console.error("CycloneEngine: Invalid callback type:"), console.log(t);
              continue
          }
          const n = t(...a);
  ...
  static getIntParam({
      ...
      try {
          ...
          return "" !== t && console.error(`Cyclone Engine plugin ${this.pluginName}: Param is expected to be an integer number, but the received value was '${t}'.`), e
      }
  }
  static getFloatParam({
      ...
      try {
          ...
          return "" !== t && console.error(`Cyclone Engine plugin ${this.pluginName}: Param is expected to be a number, but the received value was '${t}'.`), e
      }
  }
  static getIntListParam({
      ...
      return this.parseArray((t ?? "").trim(), (t => {
          try {
              ...
              return "" !== t && console.error(`Cyclone Engine plugin ${this.pluginName}: Param is expected to be a list of integer numbers, but one of the items was '${t}'.`), 0
          }
      }))
  }
  ...
  static getFloatListParam({
      ...
      return this.parseArray((t || "").trim(), (t => {
          try {
              ...
              return "" !== t && console.error(`Cyclone Engine plugin ${this.pluginName}: Param ${name} is expected to be a list of numbers, but one of the items was '${t}'.`), 0
          }
      }))
  }
  static getParam({
